...
const Hero = ({ titleData, createCampaign }) => {
  ...
  return (
    <div className='relative'>
      ...
      <img
        src="https://drive.google.com/file/d/1kFqRShRbLxbqw23abZKEoDVJNkJE4sqv/view?usp=drive_link"
      ...
      <div className='relative bg-opacity-75 backgroundMain'>
        <svg
          ...
          <path
            ...
            fill="currentColor"
            d="M-164 13L-104 39.7C-44 66 76 120 196 1410316 162 436 152 556 119.7C676
                 88 796 34 916 1301036-8 1156 2 1216 7.7L1276 13V162.5H1216C1156 162.5 1036
          ...
          <div className="flex flex-col items-center justify-between xl:flex-row">
            <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
              <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight
                ...
                Solidarity <br className="hidden md:block" /> Crowd Funding
              </h2>
